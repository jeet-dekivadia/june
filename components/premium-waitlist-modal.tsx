...
export function PremiumWaitlistModal({ isOpen, onClose, inline = false }: WaitlistModalProps) {
  ...
  const modalContent = (
    ...
    <motion.div
      ...
      initial={{ opacity: 0, scale: 0.85, y: inline ? 0 : 60 }}

      animate={{ opacity: 1, scale: 1, y: 0 }}

      exit={{ opacity: 0, scale: 0.85, y: inline ? 0 : 60 }}
