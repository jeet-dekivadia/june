...
export function HomeClient() {
  ...
  if (isMobile) {
    return (
      <div className="flex flex-col gap-1 h-screen overflow-hidden p-2">
        <div className="flex-shrink-0">
          <CardWithNav>
            <WaitlistWrapper>
              {/* Heading */}
              <div className="space-y-2">
                <h1 className="text-lg font-medium text-white whitespace-pre-wrap text-pretty drop-shadow-lg">
                  Welcome to the Future of Dating.
                </h1>
                <div className="text-white/90 text-xs [&>p]:tracking-tight text-pretty">
                  <p className="drop-shadow-sm">
                    Meet your perfect match through AI-powered conversations. No endless swiping. No ghosting. No fake profiles.
                  </p>
                </div>
